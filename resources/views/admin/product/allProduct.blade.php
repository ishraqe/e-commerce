...
<table class="table table-hover">
  ...
  <tbody>
    ...
    <tr class="text-center" id="eachProduct-{{$p->id}}">
                ...
                <fieldset class="form-group">
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" class="form-control form-check-input" name="is_sold" id="optionsRadios1" value="1" checked>
                            Yes
                        </label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" class="form-control form-check-input" name="is_sold" id="optionsRadios2" value="0">
                            No
                        </label>
                    </div>
                </fieldset>
